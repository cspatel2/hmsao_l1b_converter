# %%
'''
this file is written to be used as a l1a converter for png files (written for calibration lamp images from hms)
As of June 9, 2025 - l1a_converter_png.py is the replacement file for the current file and is located in L1A_converter folder. it is identical to the l1a_converter.py but for the png use case. 
'''
# %%
